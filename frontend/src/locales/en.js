export default {
  translation: {
    ...
    'userForm.label.signupUsername': 'Username',
    ...
    'userForm.submitBtn.signup': 'Sign up',
    'userForm.submitBtn.login': 'Log in',
